...
feature "User checks a recipe's deliciousness", %(
  ...
  scenario "user visits root path to access the form" do
    visit '/'
  ...
  scenario "user submits a recipe name containing 'pickled beets'" do
    visit '/'
    fill_in 'Recipe Name', with: 'Red Velvet Cup Cakes with Pickled Beets Frosting'
    click_button 'Submit'
  ...
  scenario "user submits a recipe name without 'pickled beets'" do
    visit '/'
    fill_in 'Recipe Name', with: 'Chocolate-Balsamic soaked Strawberries with Sweet Creme Fresh'
    click_button 'Submit'
